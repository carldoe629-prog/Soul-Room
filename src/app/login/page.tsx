...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-[100dvh] w-full overflow-hidden bg-[#0A0A0C] flex flex-col items-center justify-center pt-8 pb-4 px-8 font-[Outfit]">
      ...
      {/* SR Logo Box */}
      <div className="relative z-10 w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#FF4B6E] to-[#FF8D5C] flex xl:items-center items-center justify-center shadow-[0_0_30px_rgba(255,75,110,0.3)] mb-6">
